...
class MailTemplates {
    ...
    static applicationConfirmation(candidateName, jobTitle, companyName) {
        return `
            <html>
                <head><style>${this.baseStyles}</style></head>
                <body>
    ...
    static statusUpdate(candidateName, jobTitle, newStatus) {
        return `
            <html>
                <head><style>${this.baseStyles}</style></head>
                <body>
...
exports.MailTemplates = MailTemplates;
MailTemplates.baseStyles = `
