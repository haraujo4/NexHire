...
import { Building2, Briefcase, Users, LayoutDashboard, LogOut, Menu, X, ChevronDown, User } from "lucide-react"
...
export function CompanyLayout() {
    ...
    return (
        <div className="flex h-screen bg-[var(--color-background)] overflow-hidden">
            ...
            {/* Sidebar remains fixed/relative depending on screen */}
            <aside className={`
            ...
            `}>
                <div className="h-16 flex items-center justify-between px-6 border-b border-gray-200 shrink-0">
                    <div className="flex items-center">
                        <Building2 className="w-6 h-6 text-[var(--color-primary)] mr-2" />
