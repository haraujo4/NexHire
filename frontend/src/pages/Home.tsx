            ...
            <div className="max-w-4xl w-full text-center space-y-8">
                <div className="flex flex-col items-center space-y-4">
                    <div className="bg-white p-4 rounded-2xl shadow-xl border border-blue-50">
                        <Building2 className="w-16 h-16 text-[var(--color-primary)]" />
                    </div>
                    <h1 className="text-5xl font-black tracking-tight text-gray-900 sm:text-6xl">
                        Bem-vindo ao <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600">RhLegal</span>
                    </h1>
                ...
                <div className="pt-12 text-gray-400 text-sm">
                    © 2026 RhLegal - Recrutamento inteligente para a era Digital
                </div>
            </div>
        </div>
    )
