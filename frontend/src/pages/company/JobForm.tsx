...
export function JobForm() {
    ...
    const handleSuggestSkills = async () => {
        ...
        try {
            ...
            const suggested = response.data.skills.join(', ');
    ...
    const handleGenerateQuestions = async () => {
        ...
        try {
            ...
            const response = await api.post('/company/jobs/assist/questions', { description, requirements: reqs });
            setCustomForm(prev => [...prev, ...response.data.questions]);
        } catch (error) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (isEdit) {
                await api.put(`/company/jobs/${id}`, data)
            } else {
                await api.post('/company/jobs', { ...data, manual: true })
            }
